...
namespace OwnPass {
    ...
    optional<Group> Category::find_group(string &group_name) {
    ...
    list<reference_wrapper<Group>> Category::find_groups(string &search) {
    ...
    Category &Category::remove_group(string &group_name) {
