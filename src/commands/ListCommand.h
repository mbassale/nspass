...
namespace NSPass::Commands {
	...
	public:
		...
		explicit ListCommand(NSPass::Application& app, Format format, Filter filter = EmptyFilter)
	...
	protected:
		...
		NSPass::CLI::Output::TableOutputPtr create_table_output(const std::vector<std::string>& headers);
	};
}
