...
namespace Catch {
	...
	{
		m_resultCapture
				.handleUnexpectedInflightException(m_assertionInfo, Catch::translateActiveException(), m_reaction);
	}
...
namespace Catch {
	...
	AssertionStats::AssertionStats(AssertionResult const& _assertionResult,
			...
			:assertionResult(_assertionResult),
			 ...
			 totals(_totals)
	{
		assertionResult.m_resultData.lazyExpression.m_transientExpression = _assertionResult.m_resultData.lazyExpression
